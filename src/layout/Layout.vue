        ...
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            <div class="header-breadcrumb">
              <el-breadcrumb separator="/" v-if="route.matched[0].path !== '/home'">
...
export default {
  ...
  setup() {
    ...
    onBeforeMount(() => {
      ...
      state.defaultHeight.height = document.documentElement.clientHeight + "px"
    })
...
.aside-menu:not(.el-menu--collapse) .el-menu-item.is-active {
...
.el-header .header-collapse {
  cursor: pointer;
}

.el-header .header-breadcrumb {
  padding-top: 0.9em;
}
