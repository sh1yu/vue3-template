<template>
  <div class="login" :style="login">
    <el-row :gutter="10" class="login-container">
      <el-form :model="loginForm" :rules="rules" ref="validateForm" label-width="1em" class="login-body" hide-required-asterisk="false">
        ...
        <el-form-item prop="imgCode">
          <el-row>
            <el-col :span="14">
              <el-input v-model="loginForm.imgCode" prefix-icon="el-icon-message" placeholder="请输入验证码"></el-input>
            </el-col>
...
export default {
  setup() {
    ...
    onBeforeMount(() => {
      state.login.height = document.documentElement.clientHeight + "px"
    })
